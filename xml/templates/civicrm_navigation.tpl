...
SET @contactReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/1?reset=1', '{ts escape="sql" skip="true"}Constituent Summary{/ts}', 'Constituent Summary', 'administer CiviCRM', '', @contactReportLastID, '1', 0, 1 );
SET @constituentSummaryReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/2?reset=1', '{ts escape="sql" skip="true"}Constituent Detail{/ts}', 'Constituent Detail', 'administer CiviCRM', '', @contactReportLastID, '1', 0, 2 );
SET @constituentDetailReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/3?reset=1', '{ts escape="sql" skip="true"}Activities{/ts}', 'Activities', 'administer CiviCRM', '', @contactReportLastID, '1', 0, 3 );
SET @activitiesReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/4?reset=1', '{ts escape="sql" skip="true"}Current Employers{/ts}', 'Current Employers', 'administer CiviCRM', '', @contactReportLastID, '1', 0, 4 );
SET @currentEmployersReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/5?reset=1', '{ts escape="sql" skip="true"}Relationships{/ts}', 'Relationships', 'administer CiviCRM', '', @contactReportLastID, '1', 0, 5 );
SET @relationshipsReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/36?reset=1', '{ts escape="sql" skip="true"}Volunteer Report{/ts}', 'Volunteer Report', 'administer CiviCRM', '', @contactReportLastID, '1', 0, 6 );
SET @volunteerReportLastID:=LAST_INSERT_ID();
...
SET @contributionReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/6?reset=1', '{ts escape="sql" skip="true"}Contribution Summary{/ts}', 'Contribution Summary', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 1 );
SET @contributionSummaryReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/7?reset=1', '{ts escape="sql" skip="true"}Contribution Details{/ts}', 'Contribution Details', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 2 );
SET @contributionDetailsReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/8?reset=1', '{ts escape="sql" skip="true"}Repeat Contributions{/ts}', 'Repeat Contributions', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 3 );
SET @repeatContributionsReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/11?reset=1', '{ts escape="sql" skip="true"}Contributions by Organization{/ts}', 'Contributions by Organization', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 4 );
SET @contributionsByOrganizationReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/12?reset=1', '{ts escape="sql" skip="true"}Contributions by Household{/ts}', 'Contributions by Household', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 5 );
SET @contributionsByHouseholdReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/13?reset=1', '{ts escape="sql" skip="true"}Top Donors{/ts}', 'Top Donors', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 6 );
SET @topDonorsReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/9?reset=1', '{ts escape="sql" skip="true"}SYBUNT (some year but not this year){/ts}', 'SYBUNT (some year but not this year)', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 7 );
SET @sybuntReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/10?reset=1', '{ts escape="sql" skip="true"}LYBUNT (last year but not this year){/ts}', 'LYBUNT (last year but not this year)', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 8 );
SET @lybuntReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/14?reset=1', '{ts escape="sql" skip="true"}Soft Credits{/ts}', 'Soft Credits', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 9 );
SET @softCreditsReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/19?reset=1', '{ts escape="sql" skip="true"}Bookkeeping Transactions{/ts}', 'Bookkeeping Transactions', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 10 );
SET @bookkeepingTransactionsReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/16?reset=1', '{ts escape="sql" skip="true"}Personal Campaign Page Summary{/ts}', 'Personal Campaign Page Summary', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 11 );
SET @personalCampaignPageSummaryReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/15?reset=1', '{ts escape="sql" skip="true"}Contribution Aggregate by Relationship{/ts}', 'Contribution Aggregate by Relationship', 'access CiviContribute', '', @contributionReportLastID, '1', 0, 12 );
SET @contributionAggregateByRelationshipReportLastID:=LAST_INSERT_ID();
...
SET @pledgeReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/17?reset=1', '{ts escape="sql" skip="true"}Pledge Summary{/ts}', 'Pledge Summary', 'access CiviPledge', '', @pledgeReportLastID, '1', 0, 1 );
SET @pledgeSummaryReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/18?reset=1', '{ts escape="sql" skip="true"}Pledged But not Paid{/ts}', 'Pledged But not Paid', 'access CiviPledge', '', @pledgeReportLastID, '1', 0, 2 );
SET @pledgedButNotPaidReportLastID:=LAST_INSERT_ID();
...
SET @eventReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/24?reset=1', '{ts escape="sql" skip="true"}Event Participants List{/ts}', 'Event Participants List', 'access CiviEvent', '', @eventReportLastID, '1', 0, 1 );
SET @eventParticipantsListReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/27?reset=1', '{ts escape="sql" skip="true"}Attendee List{/ts}', 'Attendee List', 'access CiviEvent', '', @eventReportLastID, '1', 0, 2 );
SET @attendeeListReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/25?reset=1', '{ts escape="sql" skip="true"}Event Income Summary{/ts}', 'Event Income Summary', 'access CiviEvent', '', @eventReportLastID, '1', 0, 3 );
SET @eventIncomeSummaryReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/26?reset=1', '{ts escape="sql" skip="true"}Event Income Details{/ts}', 'Event Income Details', 'access CiviEvent', '', @eventReportLastID, '1', 0, 4 );
SET @eventIncomeDetailsReportLastID:=LAST_INSERT_ID();
...
SET @mailingReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/30?reset=1', '{ts escape="sql" skip="true"}Mail Bounces{/ts}', 'Mail Bounces', 'access CiviMail', '', @mailingReportLastID, '1', 0, 1 );
SET @mailBouncesReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/31?reset=1', '{ts escape="sql" skip="true"}Mailing Summary{/ts}', 'Mailing Summary', 'access CiviMail', '', @mailingReportLastID, '1', 0, 2 );
SET @mailingSummaryReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/32?reset=1', '{ts escape="sql" skip="true"}Mail Opened{/ts}', 'Mail Opened', 'access CiviMail', '', @mailingReportLastID, '1', 0, 3 );
SET @mailOpenedReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/33?reset=1', '{ts escape="sql" skip="true"}Mail Clickthroughs{/ts}', 'Mail Clickthroughs', 'access CiviMail', '', @mailingReportLastID, '1', 0, 4 );
SET @mailClickthroughsReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/34?reset=1', '{ts escape="sql" skip="true"}Mailing Details{/ts}', 'Mailing Details', 'access CiviMail', '', @mailingReportLastID, '1', 0, 5 );
SET @mailingDetailsReportLastID:=LAST_INSERT_ID();
...
SET @membershipReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/20?reset=1', '{ts escape="sql" skip="true"}Membership Summary{/ts}', 'Membership Summary', 'access CiviMember', '', @membershipReportLastID, '1', 0, 1 );
SET @membershipSummaryReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/21?reset=1', '{ts escape="sql" skip="true"}Membership Details{/ts}', 'Membership Details', 'access CiviMember', '', @membershipReportLastID, '1', 0, 2 );
SET @membershipDetailsReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/23?reset=1', '{ts escape="sql" skip="true"}Lapsed Memberships{/ts}', 'Lapsed Memberships', 'access CiviMember', '', @membershipReportLastID, '1', 0, 3 );
SET @lapsedMembershipReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/22?reset=1', '{ts escape="sql" skip="true"}Contribution and Membership Details{/ts}', 'Contribution and Membership Details', 'access CiviMember', '', @membershipReportLastID, '1', 0, 4 );
SET @contributionAndMembershipDetailsReportLastID:=LAST_INSERT_ID();
...
SET @campaignReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/35?reset=1', '{ts escape="sql" skip="true"}Survey Details{/ts}', 'Survey Details', 'interview campaign contacts,release campaign contacts,reserve campaign contacts,manage campaign,administer CiviCampaign,gotv campaign contacts', 'OR', @campaignReportLastID, '1', 0, 1 );
SET @surveyDetailsReportLastID:=LAST_INSERT_ID();
...
SET @grantReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/28?reset=1', '{ts escape="sql" skip="true"}Grant Details{/ts}', 'Grant Details', 'access CiviGrant', '', @grantReportLastID, '1', 0, 1 );
SET @grantDetailsReportLastID:=LAST_INSERT_ID();

INSERT INTO civicrm_navigation
    ( domain_id, url, label, name, permission, permission_operator, parent_id, is_active, has_separator, weight )
VALUES
    ( @domainID, 'civicrm/report/instance/29?reset=1', '{ts escape="sql" skip="true"}Grant Statistics{/ts}', 'Grant Statistics', 'access CiviGrant', '', @grantReportLastID, '1', 0, 2 );
SET @grantStatisticsReportLastID:=LAST_INSERT_ID();
